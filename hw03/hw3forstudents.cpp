...
// Makefile:
// all:
//    g++ -g -std=c++14 -I. -Wall -o hw3 hw3forstudents.cpp -lpthread
...
// Add dereferenced ptr value to the accumulator
...
// Add or remove dereferenced ptr value from accumulator. Reset ptr value after each spin cycle
...
void coherency_tests() {
    ...
    for(auto num_threads = 1; num_threads <= max_threads; ++num_threads) {
        ...
        // test 1 - Each thread only reads the data from array location: 
        int *test1 = new int[1];
        test1[0] = 3;
